...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        operador_uno = self.txt_operador_a.get()
        operador_dos = self.txt_operador_b.get()
        
        operador_uno = int(operador_uno)
        operador_dos = int(operador_dos)

        suma_total = operador_uno + operador_dos

        alert("Datos", f"El resultado de la suma es: {suma_total} ")
    ...
    def btn_restar_on_click(self):
        ...
        resta_total = operador_uno - operador_dos

        alert("Datos", f"El resultado de la resta es: {resta_total} ")
    ...
    def btn_multiplicar_on_click(self):
        ...
        multiplicacion_total = operador_uno * operador_dos
        alert("Datos", f"El resultado de la multiplicacion es: {multiplicacion_total} ")
    ...
    def btn_dividir_on_click(self):
        ...
        división_total = operador_uno / operador_dos
        alert("Datos", f"El resultado de la división es: {división_total} ")
